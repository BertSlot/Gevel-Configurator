...
namespace PointCloudConverter.Writers
{
    public class UCPC : IWriter
    {
        ...
        {
            Debug.Log("Combining files: " + Path.GetFileName(headerTempFile) + "," + Path.GetFileName(pointsTempFile) + "m" + Path.GetFileName(colorsTempFile));
            Debug.Log("Output: " + importSettings.outputFile);
            ...
            Debug.Log("Deleting temporary files: " + Path.GetFileName(headerTempFile) + "," + Path.GetFileName(pointsTempFile) + "," + Path.GetFileName(colorsTempFile));
