Shader "UnityCoder/PointCloud/DX11/ColorSizeV2-dev-prop"
{
	Properties
	{
		...
		SubShader
	{
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(Props)
				...
				UNITY_DEFINE_INSTANCED_PROP(StructuredBuffer<half3>, buf_Points)
				UNITY_DEFINE_INSTANCED_PROP(StructuredBuffer<fixed3>, buf_Colors)
